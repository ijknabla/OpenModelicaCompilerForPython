...
class OpenModelica(
    ...
    class Scripting(
        ...
        @modelica_name("OpenModelica.Scripting.getHomeDirectoryPath")
        class getHomeDirectoryPath(
            ModelicaFunction,
        ):
            """
            ```modelica
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    funcName="getHomeDirectoryPath",
                    inputArguments=[],
                    outputArguments=[
                        (Component(String), "homeDirectoryPath"),
                    ],
                    parser=parse_OMCValue,
                )
        ...
        class getMessagesStringInternal(
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    outputArguments=[
                        (
                            Component(OpenModelica.Scripting.ErrorMessage)[:],
                            "messagesString",
                        ),
                    ],
                    parser=parse_OMCValue,
        ...
        @modelica_name("OpenModelica.Scripting.saveTotalModelDebug")
        class saveTotalModelDebug(
            ModelicaFunction,
        ):
            """
            ```modelica
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    inputArguments=[
                        ...
                        (
                            Component(OpenModelica.Scripting.ExportKind),
                            "exportKind",
                            exportKind,
                            "optional",
                        ),
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    inputArguments=[
                        ...
                        (
                            Component(OpenModelica.Scripting.DiffFormat),
                            "diffFormat",
                            diffFormat,
                            "optional",
                        ),
        ...
        class reopenStandardStream(
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    inputArguments=[
                        (
                            Component(OpenModelica.Scripting.StandardStream),
                            "_stream",
                            _stream,
                            "required",
                        ),
        ...
        @modelica_name("OpenModelica.Scripting.getAvailableLibraryVersions")
        class getAvailableLibraryVersions(
            ModelicaFunction,
        ):
            """
            ```modelica
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    funcName="getAvailableLibraryVersions",
                    inputArguments=[
                        (
                            Component(TypeName),
                            "libraryName",
                    ...
                    outputArguments=[
                        (Component(String)[:], "librariesAndVersions"),
                    ],
                    parser=parse_OMCValue,
                )
        ...
        @modelica_name("OpenModelica.Scripting.getAvailablePackageVersions")
        class getAvailablePackageVersions(
            ModelicaFunction,
        ):
            """
            ```modelica
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    funcName="getAvailablePackageVersions",
                    inputArguments=[
                        (Component(TypeName), "pkg", pkg, "required"),
                        (Component(String), "version", version, "required"),
                    ],
                    outputArguments=[
        ...
        class getAvailablePackageConversionsTo(
            ModelicaFunction,
        ):
            """
            ```modelica
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    funcName="getAvailablePackageConversionsTo",
                    inputArguments=[
                        (Component(TypeName), "pkg", pkg, "required"),
                        (Component(String), "version", version, "required"),
                    ],
                    outputArguments=[
                        (Component(String)[:], "convertsTo"),
                    ],
                    parser=parse_OMCValue,
                )
        ...
        class getAvailablePackageConversionsFrom(
            ModelicaFunction,
        ):
            """
            ```modelica
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    funcName="getAvailablePackageConversionsFrom",
                    inputArguments=[
                        (Component(TypeName), "pkg", pkg, "required"),
                        (Component(String), "version", version, "required"),
                    ],
        ...
        class GC_get_prof_stats(
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    outputArguments=[
                        (
                            Component(OpenModelica.Scripting.GC_PROFSTATS),
                            "gcStats",
                        ),
                    ],
                    parser=parse_OMCValue,
        ...
        @modelica_name("OpenModelica.Scripting.runConversionScript")
        class runConversionScript(
            ModelicaFunction,
        ):
            """
            ```modelica
        ...
        @modelica_name("OpenModelica.Scripting.convertPackageToLibrary")
        class convertPackageToLibrary(
            ModelicaFunction,
        ):
            """
            ```modelica
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    funcName="convertPackageToLibrary",
                    inputArguments=[
                        (
                            Component(TypeName),
                            "packageToConvert",
                        ...
                        (Component(TypeName), "library", library, "required"),
                        (
                            Component(String),
                            "libraryVersion",
                            libraryVersion,
        ...
        @modelica_name("OpenModelica.Scripting.getModelInstance")
        ...
        @modelica_name("OpenModelica.Scripting.storeAST")
        class storeAST(
            ModelicaFunction,
        ):
            """
        ...
        @modelica_name("OpenModelica.Scripting.restoreAST")
        class restoreAST(
            ModelicaFunction,
        ):
            """
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    funcName="restoreAST",
                    inputArguments=[
                        (Component(Integer), "id", id, "required"),
                    ],
                    outputArguments=[
                        (Component(Boolean), "success"),
                    ],
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    inputArguments=[
                        (Component(String), "cref", cref, "required"),
                        (
                            Component(OpenModelica.Scripting.oms_causality),
                            "causality",
                            causality,
                            "required",
                        ),
                        (
                            Component(OpenModelica.Scripting.oms_signal_type),
                            "type_",
                            type_,
                            "required",
                        ),
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    inputArguments=[
                        (Component(String), "cref", cref, "required"),
                        (
                            Component(OpenModelica.Scripting.oms_system),
                            "type_",
                            type_,
                            "required",
                        ),
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    inputArguments=[
                        (Component(String), "cref", cref, "required"),
                        (
                            Component(OpenModelica.Scripting.oms_tlm_domain),
                            "domain",
                            domain,
                            "required",
                        ),
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    inputArguments=[
                        (Component(String), "signal", signal, "required"),
                        (
                            Component(OpenModelica.Scripting.oms_fault_type),
                            "faultType",
                            faultType,
                            "required",
                        ),
            ...
            def _(
                ...
                return _session_.__omc__.call_function(
                    ...
                    inputArguments=[
                        (Component(String), "cref", cref, "required"),
                        (
                            Component(OpenModelica.Scripting.oms_solver),
                            "solver",
                            solver,
                            "required",
                        ),
