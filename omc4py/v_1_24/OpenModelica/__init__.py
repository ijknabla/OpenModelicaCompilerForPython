...
class Scripting(package[T_Calling]):
    ...
    loadClassContentString = scripting.loadClassContentString
    ...
    translateModel = scripting.translateModel
    ...
    setElementType = scripting.setElementType
    ...
    getModelInstanceAnnotation = scripting.getModelInstanceAnnotation
