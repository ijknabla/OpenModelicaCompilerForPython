...
class GenericSession(BasicSession[T_Calling]):
    ...
    loadClassContentString = openModelica.scripting.loadClassContentString
    ...
    translateModel = openModelica.scripting.translateModel
    ...
    setElementType = openModelica.scripting.setElementType
