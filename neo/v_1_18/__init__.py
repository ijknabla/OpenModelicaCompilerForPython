...
class OpenModelica(package):
  ...
  output TypeName names[:];
        ...
        @classmethod
        def loadFileInteractiveQualified(_, filename: str, encoding: str=..., uses: bool=..., notify: bool=..., requireExactVersion: bool=...) -> List[TypeName]:
  ...
  output String qtHeader;
        ...
        @external('.OpenModelica.Scripting.convertPackage')
        @classmethod
        def convertPackage(_, cl: Union[TypeName, str], scriptFile: str) -> None:
...
class Session(BasicSession):
    ...
    convertPackage = OpenModelica.Scripting.convertPackage
