...
class OpenModelica(package):
  ...
  output CheckSettingsResult result;
        ...
        @classmethod
        def loadFile(_, fileName: str, encoding: str=..., uses: bool=..., notify: bool=..., requireExactVersion: bool=...) -> bool:
            """function loadFile
  ...
  output Boolean success;
        ...
        @classmethod
        def loadFiles(_, fileNames: Sequence[str], encoding: str=..., numThreads: int=..., uses: bool=..., notify: bool=..., requireExactVersion: bool=...) -> bool:
            """function loadFiles
  ...
  output Boolean success;
        ...
        @classmethod
        def parseEncryptedPackage(_, fileName: str, workdir: str=...) -> List[TypeName]:
  ...
  output TypeName names[:];
        ...
        @classmethod
        def loadEncryptedPackage(_, fileName: str, workdir: str=..., skipUnzip: bool=..., uses: bool=..., notify: bool=..., requireExactVersion: bool=...) -> bool:
  ...
  output TypeName names[:];
        ...
        @classmethod
        def loadFileInteractive(_, filename: str, encoding: str=..., uses: bool=..., notify: bool=..., requireExactVersion: bool=...) -> List[TypeName]:
  ...
  output Boolean success;
        ...
        @classmethod
        def saveTotalModel(_, fileName: str, className: Union[TypeName, str], stripAnnotations: bool=..., stripComments: bool=..., obfuscate: bool=...) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        def saveTotalModelDebug(_, filename: str, className: Union[TypeName, str]) -> bool:
  ...
  output String result;
        ...
        @classmethod
        def dumpXMLDAE(_, className: Union[TypeName, str], translationLevel: str=..., addOriginalAdjacencyMatrix: bool=..., addSolvingInfo: bool=..., addMathMLCode: bool=..., dumpResiduals: bool=..., fileNamePrefix: str=..., rewriteRulesFile: str=...) -> dumpXMLDAE:
            """function dumpXMLDAE
  input TypeName className;
  ...
  output String contents;
        ...
        @classmethod
        def listFile(_, class_: Union[TypeName, str], nestedClasses: bool=...) -> str:
            """function listFile
  ...
  output String contents;
        ...
        @classmethod
        def diffModelicaFileListings(_, before: str, after: str, diffFormat: Union[DiffFormat__v_1_13, Literal['plain', 1, 'color', 2, 'xml', 3]]=..., failOnSemanticsChange: bool=...) -> str:
  ...
  output String[:, 2] libraries;
        ...
        @classmethod
        def solveLinearSystem(_, A: Sequence[Sequence[float]], B: Sequence[float]) -> solveLinearSystem:
  ...
  output Boolean success;
        ...
        @classmethod
        def importFMU(_, filename: str, workdir: str=..., loglevel: int=..., fullPath: bool=..., debugLogging: bool=..., generateInputConnectors: bool=..., generateOutputConnectors: bool=..., modelName: Union[TypeName, str]=...) -> str:
            """function importFMU
  ...
  output String generatedFileName "Returns the full path of the generated FMU.";
        ...
        @classmethod
        def buildEncryptedPackage(_, className: Union[TypeName, str], encrypt: bool=...) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        def simulate(_, className: Union[TypeName, str], startTime: float=..., stopTime: float=..., numberOfIntervals: int=..., tolerance: float=..., method: str=..., fileNamePrefix: str=..., options: str=..., outputFormat: str=..., variableFilter: str=..., cflags: str=..., simflags: str=...) -> SimulationResult:
            """function simulate
  ...
  record SimulationResult
    ...
    Real timeTotal;
        ...
        @classmethod
        def buildModel(_, className: Union[TypeName, str], startTime: float=..., stopTime: float=..., numberOfIntervals: int=..., tolerance: float=..., method: str=..., fileNamePrefix: str=..., options: str=..., outputFormat: str=..., variableFilter: str=..., cflags: str=..., simflags: str=...) -> List[str]:
            """function buildModel
  ...
  output Boolean result;
        ...
        @classmethod
        def linearize(_, className: Union[TypeName, str], startTime: float=..., stopTime: float=..., numberOfIntervals: int=..., stepSize: float=..., tolerance: float=..., method: str=..., fileNamePrefix: str=..., storeInTemp: bool=..., noClean: bool=..., options: str=..., outputFormat: str=..., variableFilter: str=..., cflags: str=..., simflags: str=...) -> str:
            """function linearize
  input TypeName className "the class that should simulated";
  input Real startTime = "<default>" "the start time of the simulation. <default> = 0.0";
  input Real stopTime = 1.0 "the stop time of the simulation. <default> = 1.0";
  ...
  output String linearizationResult;
        ...
        @classmethod
        def optimize(_, className: Union[TypeName, str], startTime: float=..., stopTime: float=..., numberOfIntervals: int=..., stepSize: float=..., tolerance: float=..., method: str=..., fileNamePrefix: str=..., storeInTemp: bool=..., noClean: bool=..., options: str=..., outputFormat: str=..., variableFilter: str=..., cflags: str=..., simflags: str=...) -> str:
            """function optimize
  input TypeName className "the class that should simulated";
  input Real startTime = "<default>" "the start time of the simulation. <default> = 0.0";
  input Real stopTime = 1.0 "the stop time of the simulation. <default> = 1.0";
  ...
  output TypeName classNames[:];
        ...
        @classmethod
        def getAllSubtypeOf(_, className: Union[TypeName, str], parentClass: Union[TypeName, str]=..., qualified: bool=..., includePartial: bool=..., sort: bool=...) -> List[TypeName]:
  ...
  output String[:] vars;
        ...
        @classmethod
        def filterSimulationResults(_, inFile: str, outFile: str, vars: Sequence[str], numberOfIntervals: int=..., removeDescription: bool=..., hintReadAllVars: bool=...) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        def getElementModifierNames(_, className: Union[TypeName, str], elementName: str) -> List[str]:
  ...
  output String[:] modifiers;
        ...
        @classmethod
        def getElementModifierValue(_, className: Union[TypeName, str], modifier: Union[TypeName, str]) -> str:
  ...
  output String value;
        ...
        @classmethod
        def getElementModifierValues(_, className: Union[TypeName, str], modifier: Union[TypeName, str]) -> str:
  ...
  output String value;
        ...
        @classmethod
        def removeElementModifiers(_, className: Union[TypeName, str], componentName: str, keepRedeclares: bool=...) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        def updateConnectionAnnotation(_, className: Union[TypeName, str], from_: Annotated[str, alias[Literal['from']]], to: str, annotate: str) -> bool:
  ...
  output Boolean result;
        ...
        @classmethod
        def updateConnectionNames(_, className: Union[TypeName, str], from_: Annotated[str, alias[Literal['from']]], to: str, fromNew: str, toNew: str) -> bool:
  ...
  output String[:] result;
        ...
        @classmethod
        def getConnectionList(_, className: Union[TypeName, str]) -> List[List[str]]:
  ...
  output Integer count;
        ...
        @classmethod
        def getMMfileTotalDependencies(_, in_package_name: str, public_imports_dir: str) -> List[str]:
  ...
  output String[:] total_pub_imports;
        ...
        @classmethod
        def getImportedNames(_, class_: Union[TypeName, str]) -> getImportedNames:
  ...
  output String[:] libraries;
        ...
        @classmethod
        def getAvailableLibraryVersions(_, libraryName: Union[TypeName, str]) -> List[str]:
  ...
  output String[:] librariesAndVersions;
        ...
        @classmethod
        def installPackage(_, pkg: Union[TypeName, str], version: str=..., exactMatch: bool=...) -> bool:
  ...
  output Boolean result;
        ...
        @classmethod
        def upgradeInstalledPackages(_, installNewestVersions: bool=...) -> bool:
  ...
  output Boolean result;
        ...
        @classmethod
        def getAvailablePackageVersions(_, pkg: Union[TypeName, str], version: str) -> List[str]:
  ...
  output String[:] withoutConversion;
        ...
        @classmethod
        def getAvailablePackageConversionsTo(_, pkg: Union[TypeName, str], version: str) -> List[str]:
  ...
  output String[:] convertsTo;
        ...
        @classmethod
        def getAvailablePackageConversionsFrom(_, pkg: Union[TypeName, str], version: str) -> List[str]:
  ...
  output String[:, :] uses;
        ...
        @classmethod
        def getConversionsFromVersions(_, pack: Union[TypeName, str]) -> getConversionsFromVersions:
  ...
  output String qtHeader;
        ...
        @classmethod
        def runConversionScript(_, packageToConvert: Union[TypeName, str], scriptFile: str) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        def convertPackageToLibrary(_, packageToConvert: Union[TypeName, str], library: Union[TypeName, str], libraryVersion: str) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        def getModelInstance(_, className: Union[TypeName, str], modifier: str=..., prettyPrint: bool=...) -> str:
  ...
  output String result;
        ...
        @classmethod
        def getModelInstanceIcon(_, className: Union[TypeName, str], prettyPrint: bool=...) -> str:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_addConnector(_, cref: str, causality: Union[oms_causality__v_1_14, Literal['oms_causality_input', 1, 'oms_causality_output', 2, 'oms_causality_parameter', 3, 'oms_causality_bidir', 4, 'oms_causality_undefined', 5]], type_: Union[oms_signal_type__v_1_14, Literal['oms_signal_type_real', 1, 'oms_signal_type_integer', 2, 'oms_signal_type_boolean', 3, 'oms_signal_type_string', 4, 'oms_signal_type_enum', 5, 'oms_signal_type_bus', 6]]) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_addConnectorToTLMBus(_, busCref: str, connectorCref: str, type_: str) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_addDynamicValueIndicator(_, signal: str, lower: str, upper: str, stepSize: float) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_addExternalModel(_, cref: str, path: str, startscript: str) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_addStaticValueIndicator(_, signal: str, lower: float, upper: float, stepSize: float) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_addSystem(_, cref: str, type_: Union[oms_system__v_1_14, Literal['oms_system_none', 1, 'oms_system_tlm', 2, 'oms_system_wc', 3, 'oms_system_sc', 4]]) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_addTLMConnection(_, crefA: str, crefB: str, delay: float, alpha: float, linearimpedance: float, angularimpedance: float) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_compareSimulationResults(_, filenameA: str, filenameB: str, var: str, relTol: float, absTol: float) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_deleteConnectorFromBus(_, busCref: str, connectorCref: str) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_deleteConnectorFromTLMBus(_, busCref: str, connectorCref: str) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_exportDependencyGraphs(_, cref: str, initialization: str, event: str, simulation: str) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_faultInjection(_, signal: str, faultType: Union[oms_fault_type__v_1_16, Literal['oms_fault_type_bias', 1, 'oms_fault_type_gain', 2, 'oms_fault_type_const', 3]], faultValue: float) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_listUnconnectedConnectors(_, cref: str) -> oms_listUnconnectedConnectors:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_setLoggingInterval(_, cref: str, loggingInterval: float) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_setResultFile(_, cref: str, filename: str, bufferSize: int) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_setTLMPositionAndOrientation(_, cref: str, x1: float, x2: float, x3: float, A11: float, A12: float, A13: float, A21: float, A22: float, A23: float, A31: float, A32: float, A33: float) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_setTLMSocketData(_, cref: str, address: str, managerPort: int, monitorPort: int) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_setTolerance(_, cref: str, absoluteTolerance: float, relativeTolerance: float) -> int:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_setVariableStepSize(_, cref: str, initialStepSize: float, minimumStepSize: float, maximumStepSize: float) -> int:
...
class Session(BasicSession):
    ...
    getAvailableLibraryVersions = OpenModelica.Scripting.getAvailableLibraryVersions
    ...
    getAvailablePackageVersions = OpenModelica.Scripting.getAvailablePackageVersions
    getAvailablePackageConversionsTo = OpenModelica.Scripting.getAvailablePackageConversionsTo
    getAvailablePackageConversionsFrom = OpenModelica.Scripting.getAvailablePackageConversionsFrom
