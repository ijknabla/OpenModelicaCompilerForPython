...
class OpenModelica(package):
  ...
  output TypeName names[:];
        ...
        @classmethod
        async def loadFileInteractiveQualified(_, filename: str, encoding: str=...) -> List[TypeName]:
  ...
  output TypeName names[:];
        ...
        @classmethod
        async def loadFileInteractive(_, filename: str, encoding: str=..., uses: bool=..., notify: bool=..., requireExactVersion: bool=...) -> List[TypeName]:
  ...
  output String modelicaPath;
        ...
        @classmethod
        async def getHomeDirectoryPath(_) -> str:
  ...
  output Boolean success;
        ...
        @classmethod
        async def saveTotalModel(_, fileName: str, className: Union[TypeName, str], stripAnnotations: bool=..., stripComments: bool=..., obfuscate: bool=...) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        async def saveTotalModelDebug(_, filename: str, className: Union[TypeName, str]) -> bool:
  ...
  output String contents;
        ...
        @classmethod
        async def diffModelicaFileListings(_, before: str, after: str, diffFormat: Union[DiffFormat__v_1_13, Literal['plain', 1, 'color', 2, 'xml', 3]]=..., failOnSemanticsChange: bool=...) -> str:
  ...
  output String[:, 2] libraries;
        ...
        @classmethod
        async def solveLinearSystem(_, A: Sequence[Sequence[float]], B: Sequence[float]) -> solveLinearSystem:
  ...
  output Boolean success;
        ...
        @classmethod
        async def importFMU(_, filename: str, workdir: str=..., loglevel: int=..., fullPath: bool=..., debugLogging: bool=..., generateInputConnectors: bool=..., generateOutputConnectors: bool=..., modelName: Union[TypeName, str]=...) -> str:
            """function importFMU
  ...
  output Boolean success;
        ...
        @classmethod
        async def simulate(_, className: Union[TypeName, str], startTime: float=..., stopTime: float=..., numberOfIntervals: int=..., tolerance: float=..., method: str=..., fileNamePrefix: str=..., options: str=..., outputFormat: str=..., variableFilter: str=..., cflags: str=..., simflags: str=...) -> SimulationResult:
            """function simulate
  ...
  record SimulationResult
    ...
    Real timeTotal;
        ...
        @classmethod
        async def buildModel(_, className: Union[TypeName, str], startTime: float=..., stopTime: float=..., numberOfIntervals: int=..., tolerance: float=..., method: str=..., fileNamePrefix: str=..., options: str=..., outputFormat: str=..., variableFilter: str=..., cflags: str=..., simflags: str=...) -> List[str]:
            """function buildModel
  ...
  output Boolean result;
        ...
        @classmethod
        async def linearize(_, className: Union[TypeName, str], startTime: float=..., stopTime: float=..., numberOfIntervals: int=..., stepSize: float=..., tolerance: float=..., method: str=..., fileNamePrefix: str=..., storeInTemp: bool=..., noClean: bool=..., options: str=..., outputFormat: str=..., variableFilter: str=..., cflags: str=..., simflags: str=...) -> str:
            """function linearize
  input TypeName className "the class that should simulated";
  input Real startTime = "<default>" "the start time of the simulation. <default> = 0.0";
  input Real stopTime = 1.0 "the stop time of the simulation. <default> = 1.0";
  ...
  output String linearizationResult;
        ...
        @classmethod
        async def optimize(_, className: Union[TypeName, str], startTime: float=..., stopTime: float=..., numberOfIntervals: int=..., stepSize: float=..., tolerance: float=..., method: str=..., fileNamePrefix: str=..., storeInTemp: bool=..., noClean: bool=..., options: str=..., outputFormat: str=..., variableFilter: str=..., cflags: str=..., simflags: str=...) -> str:
            """function optimize
  input TypeName className "the class that should simulated";
  input Real startTime = "<default>" "the start time of the simulation. <default> = 0.0";
  input Real stopTime = 1.0 "the stop time of the simulation. <default> = 1.0";
  ...
  output String[:] vars;
        ...
        @classmethod
        async def filterSimulationResults(_, inFile: str, outFile: str, vars: Sequence[str], numberOfIntervals: int=..., removeDescription: bool=..., hintReadAllVars: bool=...) -> bool:
  ...
  output String[:] result;
        ...
        @classmethod
        async def getConnectionList(_, className: Union[TypeName, str]) -> List[List[str]]:
  ...
  output Integer count;
        ...
        @classmethod
        async def getMMfileTotalDependencies(_, in_package_name: str, public_imports_dir: str) -> List[str]:
  ...
  output String[:] total_pub_imports;
        ...
        @classmethod
        async def getImportedNames(_, class_: Union[TypeName, str]) -> getImportedNames:
  ...
  output String[:] libraries;
        ...
        @classmethod
        async def getAvailableLibraryVersions(_, libraryName: Union[TypeName, str]) -> List[str]:
  ...
  output Boolean result;
        ...
        @classmethod
        async def getAvailablePackageVersions(_, pkg: Union[TypeName, str], version: str) -> List[str]:
  ...
  output String[:] withoutConversion;
        ...
        @classmethod
        async def getAvailablePackageConversionsTo(_, pkg: Union[TypeName, str], version: str) -> List[str]:
  ...
  output String[:] convertsTo;
        ...
        @classmethod
        async def getAvailablePackageConversionsFrom(_, pkg: Union[TypeName, str], version: str) -> List[str]:
  ...
  output String qtHeader;
        ...
        @classmethod
        async def runConversionScript(_, packageToConvert: Union[TypeName, str], scriptFile: str) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        async def convertPackageToLibrary(_, packageToConvert: Union[TypeName, str], library: Union[TypeName, str], libraryVersion: str) -> bool:
  ...
  output Boolean success;
        ...
        @classmethod
        async def getModelInstance(_, className: Union[TypeName, str], modifier: str=..., prettyPrint: bool=...) -> str:
  ...
  output String result;
        ...
        @classmethod
        async def getModelInstanceIcon(_, className: Union[TypeName, str], prettyPrint: bool=...) -> str:
  ...
  output String result;
        ...
        @classmethod
        async def modifierToJSON(_, modifier: str, prettyPrint: bool=...) -> str:
  ...
  output Integer id;
        ...
        @classmethod
        async def restoreAST(_, id: int) -> bool:
            """function restoreAST
  input Integer id;
  output Boolean success;
end restoreAST;"""
  ...
  output Integer status;
        ...
        @classmethod
        async def oms_loadSnapshot(_, cref: str, snapshot: str) -> oms_loadSnapshot:
