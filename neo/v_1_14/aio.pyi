...
class OpenModelica(package):
  ...
  output ThreadData threadData;
    ...
    class Internal(package):
        ...
        @classmethod
        async def intervalInferred(_) -> float:
  ...
  output CheckSettingsResult result;
        ...
        @classmethod
        async def loadFile(_, fileName: str, encoding: str=..., uses: bool=...) -> bool:
            """function loadFile
  ...
  output Boolean success;
        ...
        @classmethod
        async def loadFiles(_, fileNames: Sequence[str], encoding: str=..., numThreads: int=...) -> bool:
            """function loadFiles
  ...
  output TypeName names[:];
        ...
        @classmethod
        async def loadEncryptedPackage(_, fileName: str, workdir: str=...) -> bool:
  ...
  output String result;
        ...
        @classmethod
        async def dumpXMLDAE(_, className: Union[TypeName, str], translationLevel: str=..., addOriginalIncidenceMatrix: bool=..., addSolvingInfo: bool=..., addMathMLCode: bool=..., dumpResiduals: bool=..., fileNamePrefix: str=..., rewriteRulesFile: str=...) -> dumpXMLDAE:
            """function dumpXMLDAE
  input TypeName className;
  ...
  output TypeName classNames[:];
        ...
        @classmethod
        async def getAllSubtypeOf(_, class_: Union[TypeName, str], parentClass: Union[TypeName, str]=..., qualified: bool=..., includePartial: bool=..., sort: bool=...) -> List[TypeName]:
  ...
  output Integer status;
        ...
        @classmethod
        async def oms_exportDependencyGraphs(_, cref: str, initialization: str, simulation: str) -> int:
