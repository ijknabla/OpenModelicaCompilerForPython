...
from ..enumeration import Access__v_1_14, DiffFormat__v_1_13, ErrorKind__v_1_13, ErrorLevel__v_1_13, ExportKind__v_1_13, FileType__v_1_13, LinearSystemSolver__v_1_13, StandardStream__v_1_13, oms_causality__v_1_14, oms_signal_type__v_1_14, oms_solver__v_1_14, oms_system__v_1_14, oms_tlm_domain__v_1_14, oms_tlm_interpolation__v_1_14
...
class OpenModelica(package):
  ...
  output TypeName classNames[:];
        ...
        @classmethod
        def getAllSubtypeOf(_, class_: Union[TypeName, str], parentClass: Union[TypeName, str]=..., qualified: bool=..., includePartial: bool=..., sort: bool=...) -> List[TypeName]:
  ...
  output Integer status;
        ...
        @classmethod
        def oms_exportDependencyGraphs(_, cref: str, initialization: str, simulation: str) -> int:
